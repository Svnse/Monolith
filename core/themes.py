...
class Theme:
    ...
    # Status green (verdict GREEN, grounded, running) — defaulted so presets and
    # saved custom themes without the field keep working (UI_CONTRACT §3).
    fg_ok: str = "#88cc88"
...
SLATE = Theme(
    name="Slate",
    # Apple/ollama-style light shell
    bg_main="#f7f7f8",           # Conversation field
    bg_sidebar="#ffffff",        # Base shell
    bg_panel="#ffffff",          # Assistant elevation
    bg_group="#f7f7f8",          # Groups match main
    bg_surface_1="#ffffff",
    bg_surface_2="#f2f3f5",
    bg_input="#ffffff",          # Inputs sit on white
    # Buttons: minimal, low-contrast
    bg_button="#ffffff",
    bg_button_hover="#f2f3f5",
    bg_button_pressed="#e9ebef",
    bg_button_disabled="#f7f7f8",
    # Borders: hairline, soft gray
    border_dark="#d1d5db",
    border_light="#e5e7eb",
    border_subtle="#eef0f2",
    # Text: crisp, minimal
    fg_text="#111827",           # Primary text
    fg_dim="#6b7280",            # Secondary / labels
    fg_accent="#007aff",         # iOS blue
    fg_error="#dc2626",
    fg_warn="#d97706",
    fg_placeholder="#9ca3af",
    fg_info="#8b949e",
    fg_secondary="#4b5563",
    # Accent: Apple blue
    accent_primary="#007aff",
    accent_primary_dark="#005ecb",
    accent_warm="#c97d2e",
    # Glass: bright, subtle borders
    glass_bg="rgba(255, 255, 255, 235)",
    glass_border="rgba(0, 122, 255, 28)",
    glass_hover="rgba(0, 122, 255, 10)",
    # Overseer: light surface, blue pulse
    overseer_bg="#f3f4f6",
    overseer_fg="#007aff",
    overseer_dim="#9bbcf1",
    overseer_border="#e5e7eb",
    # Scrollbar: soft gray
    scrollbar_handle="#d1d5db",
    scrollbar_handle_hover="#c7cbd3",
    # Minimal gradient identity
    gradient_color="#007aff",
)
